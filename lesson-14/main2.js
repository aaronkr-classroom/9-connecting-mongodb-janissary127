...
const port = 3000,
  ...
  Subscriber = require("./models/subscriber"),   // @TODO: Subscriber 모델 가져오기
  app = express();
...
mongoose.connect(
  "mongodb+srv://ut-node:MLreZjstmghAVcQb@ut-node.msefbvf.mongodb.net/?retryWrites=true&w=majority&appName=UT-node/ut-node",  //URL
